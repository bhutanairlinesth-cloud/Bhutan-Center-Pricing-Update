...
function mapSettings(row: any): GlobalSettings {
  return {
    ...
    hotel5StarMarginTHB: Number(row.hotel_5_star_margin_thb ?? 10000),
    agentServiceFee4D3NTHB: Number(row.agent_service_fee_4d3n_thb ?? 1500),
    agentServiceFee5D4NTHB: Number(row.agent_service_fee_5d4n_thb ?? 2000),
    agentServiceFee6D5NTHB: Number(row.agent_service_fee_6d5n_thb ?? 2500),
...
function settingsRow(settings: GlobalSettings) {
  ...
  return {
    ...
    hotel_5_star_margin_thb: Math.max(0, settings.hotel5StarMarginTHB ?? 10000),
    agent_service_fee_4d3n_thb: Math.max(0, settings.agentServiceFee4D3NTHB ?? 1500),
    agent_service_fee_5d4n_thb: Math.max(0, settings.agentServiceFee5D4NTHB ?? 2000),
    agent_service_fee_6d5n_thb: Math.max(0, settings.agentServiceFee6D5NTHB ?? 2500),
