...
const copy = {
  th: {
    ...
    businessUpgrade: 'อัปเกรดชั้นธุรกิจ', businessUpgradeHint: 'เพิ่ม 15,000 บาทต่อท่าน', singleRoom: 'พักเดี่ยว', singleRoomHint: 'เลือกจำนวนผู้เดินทางที่ต้องการห้องพักเดี่ยว', singleRoomCount: 'จำนวนผู้พักเดี่ยว', singleSupplement: 'ส่วนต่างพักเดี่ยว / ท่าน', packageDefault: 'ราคาตั้งต้นของแพ็กเกจ', resetDefault: 'ใช้ราคาตั้งต้น', people: 'ท่าน', nights: 'คืน',
