...
const copy = {
  th: {
    ...
    businessUpgrade: 'อัปเกรดชั้นธุรกิจ', businessUpgradeHint: 'เพิ่ม 15,000 บาทต่อท่าน', people: 'ท่าน', nights: 'คืน',
  ...
  en: {
    ...
    businessUpgrade: 'Business class upgrade', businessUpgradeHint: 'Add THB 15,000 per passenger', people: 'pax', nights: 'nights',
