...
const copy = {
  th: {
    ...
    role: 'สิทธิ์', admin: 'ผู้ดูแลระบบ', sales: 'ฝ่ายขาย', userNote: 'เพิ่มบัญชีผู้ใช้งานใหม่จากหน้านี้ได้โดยตรง พร้อมกำหนดสิทธิ์ Admin หรือ Sales',
  ...
  en: {
    ...
    role: 'Role', admin: 'Administrator', sales: 'Sales', userNote: 'Create user accounts directly here and assign an Admin or Sales role.',
